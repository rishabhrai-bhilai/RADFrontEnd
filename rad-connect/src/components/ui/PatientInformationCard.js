    ...
    <div className="personal-info">
      ...
      <div className="patient-info">
        ...
        <div className="patient-info--attribute-container">
          ...
          <div className="patient-info--attribute">
            <div>Height :</div>{" "}
            <span className="text-blue-extradark">{patient.height} cm</span>
          </div>
          <div className="patient-info--attribute">
            <div>Weight :</div>{" "}
            <span className="text-blue-extradark">{patient.weight} kg</span>
          </div>
          <div className="patient-info--attribute">
            <div>Blood Group :</div>{" "}
            <span className="text-blue-extradark extra-margin">
              {patient.bloodGroup}
            </span>
          </div>
          <div className="patient-info--attribute">
            <div>Gender :</div>{" "}
            <span className="text-blue-extradark">{patient.gender}</span>
          </div>
        </div>
      </div>
    </div>
